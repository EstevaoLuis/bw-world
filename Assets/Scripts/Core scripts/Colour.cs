	...
	void color(string spellColor) {
		...
		if (isColoured) {
			switch (spellColor) {
				...
				case "white": if(compositeColor.r == 0 || compositeColor.b == 0 || compositeColor.g == 0) audio.Play (); compositeColor.r = 255; compositeColor.g = 255; compositeColor.b = 255; break;
			}
